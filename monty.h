...
void func_swap(stack_t **head, unsigned int);
void func_add(stack_t **head, unsigned int);
void func_nop(stack_t **head, unsigned int);
...
void func_pstr(stack_t **head, unsigned int);
...
void func_queue(stack_t **head, unsigned int);
void func_stack(stack_t **head, unsigned int);
#endif
